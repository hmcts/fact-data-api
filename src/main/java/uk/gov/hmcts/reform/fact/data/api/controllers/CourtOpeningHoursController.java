...
public class CourtOpeningHoursController {
    ...
    public ResponseEntity<CourtOpeningHours> getOpeningHoursByTypeId(
        ...
        return ResponseEntity.ok(
            courtOpeningHoursService
                .getOpeningHourByTypeId(UUID.fromString(courtId), UUID.fromString(openingHourTypeId)));
    }
    ...
    @ApiResponses(value = {
        @ApiResponse(responseCode = "204", description = "Successfully deleted opening hours"),
