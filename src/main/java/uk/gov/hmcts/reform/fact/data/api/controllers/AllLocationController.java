...
public class AllLocationController {
    ...
    @GetMapping("/all/courts/v1")
    @Operation(summary = "Get filtered and paginated courts")
    public ResponseEntity<Page<AllLocation>> getFilteredAndPaginatedCourts(
        @RequestParam(name = "pageNumber", defaultValue = "0")
        @PositiveOrZero(message = "pageNumber must be greater than or equal to 0") int pageNumber,
        @RequestParam(name = "pageSize", defaultValue = "25")
        @Positive(message = "pageSize must be greater than 0") int pageSize,
        ...
        @RequestParam(name = "sortBy", required = false) String sortBy,
        @RequestParam(name = "sortOrder", required = false) String sortOrder) {
        return ResponseEntity.ok(allLocationService.getFilteredAndPaginatedCourts(
            pageNumber,
            pageSize,
            includeClosed,
            regionId,
    ...
    @GetMapping("/all/courts/details/v1")
    @Operation(summary = "Get all court details")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Successfully retrieved court details")
    })
    public ResponseEntity<List<AllLocationDetails>> getAllCourtDetails() {
        return ResponseEntity.ok(allLocationService.getAllCourtDetails());
    }

    @GetMapping("/all/service-centres/v1")
    @Operation(summary = "Get filtered and paginated service centres")
    public ResponseEntity<Page<AllLocation>> getFilteredAndPaginatedServiceCentres(
        @RequestParam(name = "pageNumber", defaultValue = "0")
        @PositiveOrZero(message = "pageNumber must be greater than or equal to 0") int pageNumber,
        @RequestParam(name = "pageSize", defaultValue = "25")
        @Positive(message = "pageSize must be greater than 0") int pageSize,
        ...
        @RequestParam(name = "sortBy", required = false) String sortBy,
        @RequestParam(name = "sortOrder", required = false) String sortOrder) {
        return ResponseEntity.ok(allLocationService.getFilteredAndPaginatedServiceCentres(
            pageNumber,
            pageSize,
            includeClosed,
            regionId,
    ...
    @GetMapping("/all/service-centres/details/v1")
    @Operation(summary = "Get all service centre details")
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "Successfully retrieved service centre details")
    })
    public ResponseEntity<List<AllLocationDetails>> getAllServiceCentreDetails() {
        return ResponseEntity.ok(allLocationService.getAllServiceCentreDetails());
    }
}
