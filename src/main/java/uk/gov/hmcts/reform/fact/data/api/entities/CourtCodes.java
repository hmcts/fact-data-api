...
public class CourtCodes implements AuditableCourtEntity {
    ...
    @Size(max = ValidationConstants.GBS_CODE_MAX_LENGTH,
        message = ValidationConstants.GBS_CODE_MAX_LENGTH_MESSAGE
    )
    @Pattern(regexp = ValidationConstants.GBS_CODE_REGEX,
        message = ValidationConstants.GBS_CODE_REGEX_MESSAGE
    )
