...
public final class CourtAddressControllerFunctionalTest {
    ...
    void shouldReturnAddressesForCourt() throws Exception {
        ...
        final CourtAddress address = buildMinimalAddress(courtId, "NW10 4DX", AddressType.VISIT_US);
    ...
    void shouldReturnAddressById() throws Exception {
        ...
        final CourtAddress address = buildMinimalAddress(courtId, "M1 1AE", AddressType.WRITE_TO_US);
    ...
    void shouldUpdateAddressSuccessfully() throws Exception {
        ...
        final CourtAddress originalAddress = buildMinimalAddress(courtId, "L1 8JQ", AddressType.VISIT_US);
    ...
    void shouldReturn404WhenUpdatingNonExistentAddress() {
        ...
        final CourtAddress address = buildMinimalAddress(courtId, "S1 2HE", AddressType.VISIT_US);
    ...
    void shouldDeleteAddressSuccessfully() throws Exception {
        ...
        final CourtAddress address = buildMinimalAddress(courtId, "E1 6AN", AddressType.VISIT_US);
